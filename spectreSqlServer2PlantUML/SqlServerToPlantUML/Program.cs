...
namespace SqlServerToPlantUML
{
    class Program
    {
        ...
        {
            m_connString = "Server=localhost;Database=DMC;User Id=ahsanu;Password=123;Trusted_Connection=True;TrustServerCertificate=True";
            ...
            Console.WriteLine("use Connection string --> " + m_connString);
        ...
        private static void GenerateAllTables()
        {
            ...
            Console.WriteLine("Generate All Table");

            var plantUMLText = GeneratePlantUMLDiagram.GenerateAllRelationships(tableList, "SomeTitle", "DMC - All Tables.txt");
